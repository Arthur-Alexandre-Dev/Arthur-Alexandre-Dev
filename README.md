...
- 💡 Minhas linguagens principais são: [**JavaScript**](https://developer.mozilla.org/en-US/docs/Web/JavaScript) / [**TypeScript**](https://www.typescriptlang.org/docs/) e [**Python**](https://www.python.org/).
